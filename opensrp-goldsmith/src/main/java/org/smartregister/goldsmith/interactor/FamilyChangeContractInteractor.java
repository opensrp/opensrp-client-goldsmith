...
public class FamilyChangeContractInteractor implements FamilyChangeContract.Interactor {
    ...
    @Override
    public void getAdultMembersExcludeHOF(String familyID, FamilyChangeContract.Presenter presenter) {
        Runnable runnable = () -> {
    ...
    @Override
    public void getAdultMembersExcludePCG(String familyID, FamilyChangeContract.Presenter presenter) {
        Runnable runnable = () -> {
    ...
    @Override
    public void updateFamilyMember(Context context, Pair<String, FamilyMember> familyMember, String familyID, String lastLocationID, FamilyChangeContract.Presenter presenter) {
        Runnable runnable = () -> {
    ...
    private List<FamilyMember> getFamilyMembers(String familyID) {
        ...
        try {
            ...
            while (!cursor.isAfterLast()) {
                ...
                if (dob != null && (getDiffYears(dob, new Date()) >= getMinimumCareGiverAge())) {
                    res.add(columns);
                }
                cursor.moveToNext();
            }
