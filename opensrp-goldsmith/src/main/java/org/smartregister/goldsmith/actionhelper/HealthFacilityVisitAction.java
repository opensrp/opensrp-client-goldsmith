package org.smartregister.goldsmith.actionhelper;
...
public class HealthFacilityVisitAction implements BaseAncHomeVisitAction.AncHomeVisitActionHelper {
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            JSONObject jsonObject = new JSONObject(jsonPayload);
            anc_hf_visit = org.smartregister.goldsmith.util.JsonFormUtils.getValue(jsonObject, "anc_hf_visit");
            anc_hf_visit_date = org.smartregister.goldsmith.util.JsonFormUtils.getValue(jsonObject, "anc_hf_visit_date");
            weight = org.smartregister.goldsmith.util.JsonFormUtils.getValue(jsonObject, "weight");
            sys_bp = org.smartregister.goldsmith.util.JsonFormUtils.getValue(jsonObject, "sys_bp");
            dia_bp = org.smartregister.goldsmith.util.JsonFormUtils.getValue(jsonObject, "dia_bp");
            hb_level = org.smartregister.goldsmith.util.JsonFormUtils.getValue(jsonObject, "hb_level");
            ifa_received = org.smartregister.goldsmith.util.JsonFormUtils.getValue(jsonObject, "ifa_received");
            tests_done = org.smartregister.goldsmith.util.JsonFormUtils.getCheckBoxValue(jsonObject, "tests_done");
    ...
    public String postProcess(String s) {
        try {
            ...
            String value = org.smartregister.goldsmith.util.JsonFormUtils.getValue(jsonObject, "anc_hf_visit");
